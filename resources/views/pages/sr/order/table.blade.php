...
<tr>
  ...
  <td class="action-icons">
    ...
    @if($order->order_type == "field_order")
            <a href="{{ route('sr.order.view_invoice', $order->id) }}" class="icon-btn slip-icon" title="View Purchase Invoice">
              <i class="fa-solid fa-file-invoice"></i>
            </a>

        @elseif($order->order_type == "retail")
            <a href="{{ route('sr.order.view_retail_invoice', $order->id) }}" class="icon-btn slip-icon" title="View Purchase Invoice">
              <i class="fa-solid fa-file-invoice"></i>
            </a>
