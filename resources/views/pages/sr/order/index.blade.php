...
<div class="manage-card">
  ...
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    ...
    <div class="d-flex align-items-center gap-2 flex-wrap">
      ...
      <a href="{{ route('sr.order.create') }}" class="btn-smart btn-blue">
    ...
    <div class="smart-filter-grid-5">
      ...
      <div>
        ...
        <div style="position: relative;">
          <input type="text" id="searchInput" class="input-form" placeholder="BRS ID or Customer name..." style="padding-left: 32px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchFilteredOrders(pageUrl = null) {
        ...
        let url = pageUrl || "{{ route('sr.order.index.data') }}";
