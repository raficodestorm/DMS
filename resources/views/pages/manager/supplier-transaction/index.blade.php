    ...
    <div class="smart-filter-grid-6">
      ...
      <div>
        ...
        <div style="position: relative;">
          <input type="text" id="searchInput" class="input-form" placeholder="ID, Supplier..." value="{{ request('search') }}" style="padding-left: 30px;">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchTransactions(fetchUrl = null) {
        ...
        if (!url) {
            ...
            url = `{{ route('manager.supplier-transactions.index.data') }}?search=${search}&supplier_id=${supplier}&type=${type}&from_date=${from}&to_date=${to}`;
        }
