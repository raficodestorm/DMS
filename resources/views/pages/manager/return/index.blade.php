        ...
        <div class="row g-2 align-items-end">
            ...
            <div class="col-12 col-lg-5 order-1 order-lg-1">
                ...
                <div style="position: relative;">
                    <input type="text" id="search" class="input-form" placeholder="Search by BRET ID, SR, or Customer name..." value="{{ request('search') }}" style="margin-bottom: 0; padding-left: 35px; height: 42px;">
            ...
            <div class="col-6 col-lg-2 order-4 order-lg-2">
                ...
                <select id="statusFilter" class="input-form" style="margin-bottom: 0; height: 42px; padding: 5px;">
                    ...
                    <option value="pending_manager" {{ request('status') == 'pending_manager' ? 'selected' : '' }}>Pending For Approval</option>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchFilteredReturns() {
        ...
        const url = `{{ route('manager.return.index') }}?search=${query}&status=${status}&from_date=${from}&to_date=${to}`;
        ...
        .then(data => {
            ...
            if (data.mobile && document.getElementById('mobileTable')) {
