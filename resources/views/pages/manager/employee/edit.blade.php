...
<div class="container justify-center">
    <div class="form-card">
        ...
        <form class="adduser-form" method="POST" action="{{ route('manager.employees.update', $employee->id) }}"
            ...
            <div class="photo-upload">
                ...
                <div class="upload-right">
                    <div class="preview-box">
                        ...
                        @if($employee->photo)
                        <img id="photoPreview" src="{{ str_starts_with($employee->photo, 'uploads/') ? asset($employee->photo) : asset('uploads/' . $employee->photo) }}" alt="Preview"
                            style="display:block;">
        ...
        <a href="{{ route('manager.employees.index') }}" class="btn btn-secondary px-4 mt-4">Back</a>
    </div>
</div>
@endsection
@push('scripts')
