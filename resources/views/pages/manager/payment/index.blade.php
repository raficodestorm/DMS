...
<div class="manage-card">
  ...
  <div class="table-wrapper">
    <table>
      ...
      <tbody class="desktop-table" id="desktopTable">
        @include('pages.manager.payment.table')
      </tbody>
    </table>
  </div>
  ...
  <div class="manage-mobile-cards" id="mobileTable">
    @include('pages.manager.payment.mtable')
  </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function fetchFilteredPayments() {
        ...
        const url = `{{ route('manager.payments.index') }}?search=${query}&type=${type}&from_date=${from}&to_date=${to}`;
