...
<div class="manage-card">
  ...
  <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
    <div>
      <h2 class="mb-0"><i class="fas fa-scissors me-2" style="color: var(--primary);"></i>Stock Return Requests</h2>
      <p class="text-muted mb-0">Manage and track your branch's Stock Return (Cut) requests</p>
    </div>
    <div class="d-flex align-items-center gap-2 flex-wrap">
      ...
      <a href="{{ route('manager.stock.cut.create') }}" class="btn-smart btn-blue">
        <i class="fas fa-plus me-1"></i> Create Return Request
      </a>
    </div>
  </div>
    ...
    <div class="smart-filter-grid-5">
      ...
      <div>
        ...
        <div style="position: relative;">
          <input type="text" id="searchInput" class="input-form" placeholder="Search supplier / note..." value="{{ request('search') }}" style="padding-left: 32px;">
      ...
      <tbody class="desktop-table" id="requestTable">
        <tr>
          <td colspan="6" class="text-center py-5 text-muted">
            <i class="fas fa-filter me-1" style="color: var(--primary);"></i> Select filters or click the reset button to view return requests.
          </td>
        </tr>
      </tbody>
    </table>
...
document.addEventListener('DOMContentLoaded', function () {
            ...
            requestTable.innerHTML = `
                <tr>
                    <td colspan="6" class="text-center py-4 text-muted">
                        <i class="fas fa-spinner fa-spin me-2"></i> Loading stock return requests...
                    </td>
                </tr>`;
        }
        if (requestMobile) {
            ...
            requestTable.innerHTML = `
                <tr>
                    <td colspan="6" class="text-center py-4 text-danger">
                        <i class="fas fa-exclamation-circle me-1"></i> Failed to load stock return data. Please try again.
                    </td>
                </tr>`;
        }
        if (requestMobile) {
            requestMobile.innerHTML = `
                <p class="text-center text-danger py-4">
                    <i class="fas fa-exclamation-circle me-1"></i> Failed to load stock return data.
                </p>`;
        }
    }
    ...
    function fetchFilteredRequests(fetchUrl = null) {
        ...
        if (!url) {
            ...
            url = `{{ route('manager.stock.cut.data') }}?search=${search}&status=${status}&from_date=${from}&to_date=${to}`;
        }
