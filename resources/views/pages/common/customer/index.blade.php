...
<div class="manage-card">
    ...
    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
        ...
        <div class="d-flex align-items-center gap-2 flex-wrap">
            ...
            <a href="{{ route('customers.create') }}" class="btn-smart btn-blue">
        ...
        <div class="smart-filter-grid-2">
            ...
            <div>
                ...
                <div style="position: relative;">
                    <input type="text" id="searchInput" class="input-form" placeholder="Search by Shop Name, Manager, Phone or Customer ID (e.g. BRC2001)..." value="{{ request('search') }}" style="padding-left: 32px;">
                ...
                <tr>
                    <td colspan="6" class="text-center py-5 text-muted">
                        <div class="d-flex flex-column align-items-center justify-content-center gap-2">
                            <div><i class="fas fa-filter me-1" style="color: var(--primary);"></i> Select filters or click below to view customers.</div>
...
document.addEventListener('DOMContentLoaded', function () {
            ...
            customerTable.innerHTML = `
                <tr>
                    <td colspan="6" class="text-center py-4 text-muted">
                        <i class="fas fa-spinner fa-spin me-2"></i> Loading customer data...
                    </td>
                </tr>`;
        }
        if (customerMobile) {
    ...
    function fetchFilteredCustomers(fetchUrl = null) {
        ...
        if (!url) {
            ...
            url = `{{ route('customers.index.data') }}?search=${search}`;
        }
