...
<div class="manage-card">
  ...
  <div class="action-bar">
    <a href="{{ route('admin.stock.in.request.invoice', $request->id) }}" class="btn-smart btn-purple">
      <i class="fas fa-file-invoice"></i> View Invoice
    </a>
    <a href="{{ route('admin.stock.in.request.edit', $request->id) }}" class="btn-smart btn-blue">
