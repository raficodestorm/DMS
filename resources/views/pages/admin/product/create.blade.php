    ...
    <div class="pc-card">
      ...
      <div class="pc-card-body">
        ...
        <div style="margin-top:14px;">
          <label class="f-label">
            Barcode <small style="font-weight:400; color:var(--text-muted);">(Scan supplier barcode or leave blank to auto-generate)</small>
          </label>
          <div style="display:flex; gap:8px; align-items:center;">
            <div style="position:relative; flex:1;">
              ...
              <input class="f-ctrl" type="text" name="barcode" id="barcodeInput" value="{{ old('barcode') }}" placeholder="Scan with barcode scanner or enter code" style="padding-left:36px; font-family:monospace; letter-spacing:.05em;">
            </div>
            <button type="button" class="btn-smart btn-gray" id="btnGenBarcode" title="Generate EAN-13 barcode" style="white-space:nowrap; padding:9px 14px; font-size:0.8rem;">
      ...
      <div class="pc-card-body">
        ...
        <div class="g4" style="margin-top: 14px;">
          <div>
            ...
            <input class="f-ctrl" type="number" step="0.01" min="0" name="weight" value="{{ old('weight') }}" placeholder="0.00">
          ...
          <div>
            ...
            <input class="f-ctrl" type="number" step="0.01" min="0" name="length" value="{{ old('length') }}" placeholder="0.00">
          ...
          <div>
            ...
            <input class="f-ctrl" type="number" step="0.01" min="0" name="width" value="{{ old('width') }}" placeholder="0.00">
          ...
          <div>
            ...
            <input class="f-ctrl" type="number" step="0.01" min="0" name="height" value="{{ old('height') }}" placeholder="0.00">
...
(function () {
  ...
  if (longDesc) {
    ...
    // Adjust initially if there's pre-filled value
    if (longDesc.value) {
      adjustHeight();
    }
  }
