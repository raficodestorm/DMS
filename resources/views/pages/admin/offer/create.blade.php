        ...
        <form class="adduser-form" method="POST" action="{{ route('admin.offers.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="hidden" name="product_id" id="selected_product_id" value="{{ old('product_id') }}" required>
                ...
                <div class="col-md-6 mb-3" id="couponCodeContainer" style="{{ old('customer_type') == 'retail' ? '' : 'display: none;' }}">
                    ...
                    <input class="input-form" name="coupon_code" id="couponCodeInput" placeholder="e.g. CPN01" value="{{ old('coupon_code') }}">
